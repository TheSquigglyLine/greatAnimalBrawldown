  ...
  return (
    <div className="voter">
      <div className={`button-Container-left ${isSlidOut ? 'slide-out' : ''}`}>
        <button id={`Left-Button ${isSlidOut ? 'slide-out' : ''}`} className='left-button' onClick={(event) => { animateButtonClick(event, name1); }}>{name1 || "Click To Start"}</button>
      ...
      <div className={`button-Container-right ${isSlidOut ? 'slide-out' : ''}`}>
        <button id={`right-Button ${isSlidOut ? 'slide-out' : ''}`} className='right-button' onClick={(event) => { animateButtonClick(event, name2); }}>{name2 || "Click To Start"}</button>
